...
@Composable
fun DecoratedGrid(modifier: Modifier = Modifier) {
    ...
    val decorations by remember(items.size) {
        derivedStateOf { buildDecorations(items.size) }
    }
...
private fun buildDecorations(itemCount: Int): List<RowDecoration> {
...
@Composable
private fun DecoratedGridPreview() {
    AspectoTheme {
        DecoratedGrid()
    }
}
